...
import MW22token from "../contracts/MW22token.json"
...
export const connectWallet = () => {
    return async(dispatch) =>  {
        ...
        try {
            ...
            const TokenContractAddress = '0x16e9e9058854c42bfae8a6014670a696d966b26b';
            ...
            const mw22token=new web3.eth.Contract(MW22token,TokenContractAddress);
            const networkId=await web3.eth.net.getId();
            console.log('add',address);
          
            console.log('tok',mw22token);
